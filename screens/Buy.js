...
import PropCardBuy from "./PropCardBuy";
...
export default class Buy extends Component {
    ...
    firebase
      ...
      .on(
        ...
        (snapshot) => {
          ...
          this.setState({ buyProp: properties1 });
  ...
  renderItem = ({ item: story }) => {
    return <PropCardBuy story={story} navigation={this.props.navigation} />;
  };
